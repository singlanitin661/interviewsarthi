...
def translate(sentence: str):
    ...
    config = get_config()
    config['tokenizer_file'] = '..//pyt/Transformer/vocab/tokenizer_{0}.json'
    print(str(Path(config['tokenizer_file'].format(config['lang_src']))),99879798)
    print(111)
    ...
    label = ""
    # wont require the below if block
    '''
